...
class MonthBarData {
  ...
  void initializeMonthBarData() {
    monthBarData = [
      ...
      IndividualBar(20, twentyTwoDay),
      IndividualBar(20, twentyThreeDay),
      IndividualBar(20, twentyFourDay),
      IndividualBar(20, twentyFiveDay),
      IndividualBar(20, twentySixDay),
      IndividualBar(20, twentySevenDay),
      IndividualBar(20, twentyEightDay),
      IndividualBar(20, twentyNineDay),
      IndividualBar(20, thirtyDay),
      IndividualBar(20, thirtyOneDay),
    ];
  }
}
